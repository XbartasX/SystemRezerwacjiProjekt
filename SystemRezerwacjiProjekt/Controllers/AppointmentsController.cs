...
namespace SystemRezerwacjiProjekt.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,IsBooked,PatientId,DoctorId")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,IsBooked,PatientId,DoctorId")] Appointment appointment)
        {
